...
public class Network {
    ...
    public User getUser(String name) {
        ...
        for (int i = 0; i < userCount; i++) {
            String userNameLower = users[i].getName().toLowerCase();
            if (nameLower.equals(userNameLower)) {
                return users[i];
            }
        }
        return null;
    ...
    *  Otherwise, creates a new user with the given name, adds the user to this network, and returns true. */
    ...
    public String recommendWhoToFollow(String name) {
        ...
        for(int i = 0; i < userCount; i++) {
            ...
            if(recommendedUser == null) {
                ...
                maxMutualFollowees = user.countMutual(recommendedUser);
            }
            else {
                mutualFollowees = user.countMutual(users[i]);
    ...
    public String mostPopularUser() {
        ...
        int maxFolloweeCount = followeeCount(mostPopularUser.getName());
        for (int i = 0; i < userCount; i++) {
